...
public class TutorialMod
{
    ...
    // Create a Deferred Register to hold CreativeModeTabs which will all be registered under the "tutorialmod" namespace
    ...
    // Creates a new food item with the id "tutorialmod:example_id", nutrition 1 and saturation 2
    public static final RegistryObject<Item> EXAMPLE_ITEM = ITEMS.register("example_item", () -> new Item(new Item.Properties().food(new FoodProperties.Builder()
            .alwaysEat().nutrition(1).saturationMod(2f).build())));

    // Creates a creative tab with the id "tutorialmod:example_tab" for the example item, that is placed after the combat tab
